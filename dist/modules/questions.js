export class QuestionManager {
    constructor(questions, questionsPerRound) {
    ...
    buildBalancedQuestionQueue(totalQuestions) {
        ...
        difficulties.forEach((difficulty) => {
            ...
            if (available.length < requiredCount) {
                throw new Error(`Not enough ${difficulty} questions. Required ${requiredCount}, available ${available.length}.`);
            }
